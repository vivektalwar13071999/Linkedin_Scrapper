...
linkedin_username = "vivektalwar13071999@gmail.com"
...
linkedin_password = "startdnd1909"
...
print("> ", end="")
input_file_name = input("profiles_data.txt")
...
print("> ", end="")
output_file_name = input("results_profiles.xlsx")
